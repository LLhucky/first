...
<head>
    ...
    <script type="text/javascript" src="/tp32/Public/jquery.js"></script>	
    <script type="text/javascript" src="/tp32/Public/laydate.js"></script>	
</head>
<body id="message" onselectstart="return true;" ondragstart="return false;">
	<form action="<?php echo U('home/msg/search');?>" method="post">
				...
				<div class="history-date">
					<ul>
						...
						<?php if(is_array($msgs)): foreach($msgs as $key=>$msg): ?><li class="green bounceInDown">
							<h3>
								<img src="/tp32/Public/message/logo100x100.jpg"><?php echo ($msg['uname']); ?><span><?php echo date('Y-m-d H:i:s',$msg['created_at']);?></span>
								<div class="clr"></div>
							</h3>
							<dl>
	...
	<script type="text/javascript"> 
		...
		// 	$.get("<?php echo U('home/msg/search');?>",{'startTime':startTime,'endTime':endTime},function(json){
		// 		console.log(json);
		// 	},'json');
		// });
